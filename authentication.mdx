...
description: How to authenticate requests to the DataLink API.
---

## Bearer token

All requests to the DataLink API must include your API key as a Bearer token in the `Authorization` header.
