...
Fraud Signals is the highest-signal endpoint in the DataLink suite. It runs all four intelligence types — email, phone, IP, and domain — and returns a unified risk assessment with a composite fraud score. Calling each separately would cost 6 credits; the bundle saves 1 credit while delivering a richer, correlated result.
